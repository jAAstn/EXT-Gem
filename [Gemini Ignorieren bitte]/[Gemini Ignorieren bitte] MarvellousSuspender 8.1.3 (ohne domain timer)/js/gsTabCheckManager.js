...
const attemptDiscarding =
 ...
 // KORREKTUR: try...catch Block hinzugefügt, um den Verbindungsfehler abzufangen
    ...
    try {
      ...
      suspendInfo = suspendInfo || {}; // Falls die Antwort leer ist, greift der Fallback
    } catch (error) {
      gsUtils.log(tab.id, QUEUE_ID, 'Suspended tab is not ready to receive messages yet.', error);
    }
